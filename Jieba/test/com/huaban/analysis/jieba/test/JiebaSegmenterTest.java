...
public class JiebaSegmenterTest extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
		JiebaSegmenterTest t = new JiebaSegmenterTest();
		t.setUp();		// To load the user dictionary
		System.out.println("--------------------------------------------------------------------------------------------------------");
		...
		String[] sentences =
		        new String[] {"北京的希尔顿酒店", 
		                      ...
		                      "上地附近的商务酒店"};
		for (String sentence : sentences) {
			List<SegToken> segTokens = t.segmenter.process(sentence, SegMode.SEARCH);
		    System.out.println(segTokens.toString());
		}
	}
}
